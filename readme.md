...
- **Desenho Livre** — traço livre com pipeline de suavização a três fases: EMA (α=0.35) em tempo real, suavização Laplaciana pós-traço (2 iterações), e simplificação RDP (ε=1.8px). Traço limpo mesmo com ratos de baixa qualidade ou tremor de mão. O traço fecha automaticamente se o cursor terminar a menos de 12px do ponto inicial.
